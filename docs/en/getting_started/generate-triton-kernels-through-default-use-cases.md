...
2. Click ![alt text](../assets/icons/right-arrow.png){w=20px}.
   ...
   KernelGen searches for a list of GitHub repositories to find code snippets similar to the operator definitions. For more information about the list of GitHub repositories, see [text](../../zh/references/search-repo-list.md).
