...
- **Added features**：
  - Added support for creating, optimizing, and specializing operators across multiple hardware platforms via the KernelGen MCP server, AI agents, and first- and third-party skills.
