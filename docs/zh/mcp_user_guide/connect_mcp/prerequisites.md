...
在将您的 AI 智能体配置并连接至 KernelGen 算子开发 MCP 工具集之前，您必须先从 KernelGen Web 平台获取 Bearer Token。
...
- Token 具有有效期。如果 Token 已过期且无法连接 KernelGen 算子开发 MCP 工具集，您可以登录 KernelGen Web 平台获取新的 Token。
